<template>
    <div :style="styleVariables">
            ...
            <div class="row align-items-center position-relative z-2">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="text-black fw-bold">
                        <h1>
                            What is Goritmi <br />
                            <span class="c-product-text-color">Balance</span>
                        </h1>
                    </div>
                    <img
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <p class="text-muted">
                        ...
                        real-time reports for smarter financial decisions.
                    </p>
        ...
        <div class="bg-white">
            <div class="container py-5">
                <h1 class="fw-bold c-product-text-color">
                    ...
                    <span class="text-black">Everyone</span>
                </h1>
                ...
                <div class="row py-3">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mt-5">
                            <h2 class="fw-bold">
                                Target
                                <span class="c-product-text-color">Users</span>
                            </h2>
                            <h6 class="c-product-text-color">
                                Business Owners and Entrepreneurs
                                <span class="text-black"
                                    >- Monitor cash flow and track
                                    revenue.</span
                                >
                            </h6>
                            <h6 class="c-product-text-color">
                            ...
                            <h6 class="c-product-text-color">
                                ...
                                <span class="text-black"
                                    >- Track household Expanses and savings
                                    goals.</span
                                >
                            </h6>
                            <h6 class="c-product-text-color">
                                Corporate Teams & financial Managers
                                <span class="text-black"
        ...
        <!--PRICING SECTION-->
        <section class="section" id="pricing"  :style="styleVariables"> 
